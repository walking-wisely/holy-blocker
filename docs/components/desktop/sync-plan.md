...
This document records the gaps found between `docs/components/desktop/plan.md` and the rest of the
...
`docs/architecture/overview.md` should be updated to acknowledge the backend service and its scope.
...
## 2. Gaps in `docs/components/desktop/plan.md`
