...
The design rationale and phase definitions live in [../network-pipeline.md](../../architecture/network-pipeline.md).
...
- [../flows/warn-interstitial.md](../../product/flows/warn-interstitial.md) — HTML overlay injection on Warn verdict
- [../flows/protection-mode-change.md](../../product/flows/protection-mode-change.md) — how ProtectionMode propagates to the proxy at runtime
...
See [../flows/protection-mode-change.md](../../product/flows/protection-mode-change.md) for the
