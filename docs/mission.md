...
- [Architecture](architecture/overview.md) — how the technical layers implement the two-path
  blocking model described above
- [Network Pipeline](architecture/network-pipeline.md) — the five phases of network interception
