...
- `apps/desktop`: Electron + React desktop control panel, built with Vite and TypeScript.
- `packages/text-policy`: Rust package for text-policy and classification logic.
- `machine-learning`: Python package for training and exporting local ML models.
- `native-modules/win-daemon`: C++20 Win32 daemon skeleton for foreground-window and window-change monitoring.
- `docs`: Plain Markdown project documentation.
